      ...
      >
        <div className="mx-auto max-w-7xl px-4 py-20">
          <div className="mb-16">
            ...
            <h2 className="mt-3 text-5xl lg:text-6xl font-extrabold tracking-tight text-white">
              Contact Us
            </h2>
          </div>
            ...
            >
              ...
              <div className="mt-10 flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-base text-white/70 text-wrap">
                    LOT 683, BLOCK 9, JALAN PUJUT-LUTONG, C.D.T. 20<br />
